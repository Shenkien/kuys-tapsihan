...
// Same reasoning as the Kiosk page — this must never be a build-time
// static snapshot, both because the DB isn't reachable at build time and
// because table/menu state needs to be live.
